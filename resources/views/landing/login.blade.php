...
<body>
    ...
    <div class="main-canvas">
                ...
                <div class="wrapper-in d-flex justify-content-center flex-column" style="min-height: 100vh !important;">
                    <div class="card m-auto" style="border-radius: 20px; width: 60%; padding: 40px 20px;">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert"
                            ...
                            <strong>Pendaftaran Berhasil!</strong> Silahkan check email anda untuk melakukan aktivasi
                            akun.
                        ...
                        <div class="card-body">
                            <h2 class="card-title text-bold">Login</h2>

                            <p>Belum memiliki akun ? <a href="{{ route('regist.form') }}"
                                    style="color:#19663b;font-weight: 600;text-decoration: none;">Daftar disini</a></p>

                            {{-- form --}}
                            <form class="row row-cols-lg-auto g-3 align-items-center mt-4" action="https://selarasalam.resellr.id/login-reseller-partner" method="POST">
                                <input type="hidden" name="partner" value="{{ url()->current() }}">
                                ...
                                <div class="col-12 mt-5 text-center">
                                    <button type="submit" class="btn w-25 rounded-pill shadow"
                                        style="background-color: #19663b; color:#fff;">Login</button>
                                </div>
                            </form>

                            {{-- Powered --}}
                            <div class="powered text-center" style="margin-top: 70px;">
                                <p style="font-size: 12px;color: #aeaeae;">Powered by iPaymu Ecosystem (Viralmu &
                                    Resellr)
                                </p>
        ...
        <div class="row mobile-view">
            <div class="col-lg-12"style="background: linear-gradient(135deg, #19663b 0%, #113220 100%);min-height: 100vh !important;padding: 20px 0px;">
                <div class="wrapper-in d-flex justify-content-center flex-column" style="min-height: 100vh !important;">
                    <div class="image-wrapper m-auto text-center" style="z-index: 999;">
                        <img src="{{ asset('images/logo/logo-koi.png') }}" alt="" style="width : 30%">
                    </div>
                    <div class="card m-auto" style="border-radius: 20px; width: 90%; padding: 40px 10px; margin-top: -70px !important;">
